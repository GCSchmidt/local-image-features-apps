# Image Processing
MAX_IMAGE_DIM = 500  # Max width/height for feature detection
...
INLIER_THRESHOLD = 0.20  # Percentage of inliers in the overlapping area required to confirm connection between images
